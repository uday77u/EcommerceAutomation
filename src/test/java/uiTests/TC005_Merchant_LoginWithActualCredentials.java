...
public class TC005_Merchant_LoginWithActualCredentials extends BaseUITest {

	@Test
	public void testMerchant_LoginWithActualCredentials() {
		try {
		...
		//logger.info(null);
		logger.info("start logging ***testMerchant_LoginWithActualCredentials***");
        ...
        logger.error("❌ Assertion failed in testMerchant_LoginWithActualCredentials: " + ae.getMessage(), ae);
        throw ae; // rethrow so TestNG marks test as failed
    } catch (Exception e) {
        logger.error("❌ Unexpected exception in testMerchant_LoginWithActualCredentials: " + e.getMessage(), e);
