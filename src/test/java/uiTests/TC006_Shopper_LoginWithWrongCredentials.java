...
public class TC006_Shopper_LoginWithWrongCredentials extends BaseUITest {
	
	@Test
	public void testShopper_LoginWithWrongCredentials() {
		try {
		...
		//logger.info(null);
		logger.info("start logging ***testShopper_LoginWithWrongCredentials***");
		...
		logger.info("Step 3: Clicking on the 'Shopper Login'");
        ...
        logger.error("❌ Assertion failed in testShopper_LoginWithWrongCredentials: " + ae.getMessage(), ae);
        throw ae; // rethrow so TestNG marks test as failed
    } catch (Exception e) {
        logger.error("❌ Unexpected exception in testShopper_LoginWithWrongCredentials: " + e.getMessage(), e);
